...
#define CAN_MOD_SILM                     BIT5
#define CAN_MOD_LBKM                     BIT6
#define CAN_MOD_AFM0                     BIT8
#define CAN_MOD_AFM1                     BIT9
#define CAN_MOD_AFM2                     BIT10
#define CAN_MOD_AFM3                     BIT11
#define CAN_MOD_AFM4                     BIT12
#define CAN_MOD_AFM5                     BIT13
#define CAN_MOD_AFM6                     BIT14
...
typedef struct
{
    ...
    uint32_t CAN_BOR ;          /*!< CAN BUF OFF ERROR RECOVER
