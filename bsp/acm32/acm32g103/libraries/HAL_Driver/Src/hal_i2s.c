...
__weak void HAL_I2S_MspInit(I2S_HandleTypeDef *hi2s)
{
    ...
    */
	...
	{
		 /* Enable Clock */
        System_Module_Enable(EN_I2S2);
		System_Module_Enable(EN_GPIOB);
		System_Module_Enable(EN_GPIOA);
		/* I2S2 WS   PB12 PF0 */ 
        /* I2S2 CLK  PB13 PF1 */
        /* I2S2 MCK  PortA Pin8 */
        /* I2S1 SD   PortB Pin15 */
        GPIO_Handle.Pin       = GPIO_PIN_12 | GPIO_PIN_13 | GPIO_PIN_15 ;
        GPIO_Handle.Mode      = GPIO_MODE_AF_PP;
        GPIO_Handle.Pull      = GPIO_PULLUP;
        GPIO_Handle.Alternate = GPIO_FUNCTION_7;
		GPIO_Handle.Drive     =GPIO_DRIVE_LEVEL0;
		...
		GPIOC_Handle.Pin       = GPIO_PIN_8 ;
        GPIOC_Handle.Mode      = GPIO_MODE_AF_PP;
        GPIOC_Handle.Pull      = GPIO_PULLUP;
        GPIOC_Handle.Alternate = GPIO_FUNCTION_7;
		GPIOC_Handle.Drive     =GPIO_DRIVE_LEVEL0;
        HAL_GPIO_Init(GPIOA, &GPIOC_Handle);
		
		 /* Clear Pending Interrupt */
        NVIC_ClearPendingIRQ(I2S2_IRQn);       
        /* Enable External Interrupt */
