...
/** After configuring corresponding UART or UART DMA, you can use it.
  ...
  */
    ...
    #define UART1_TX_PIN            "PA.9"
    #define UART1_RX_PIN            "PA.10"
    ...
    #define UART1_RX_ALTERNATE      GPIO_FUNCTION_1
        ...
        #define UART1_RX_DMA_IRQ        DMA1_IRQn
        #define UART1_RX_DMA_CHANNEL    0
        #define UART1_RX_DMA_REQUEST    DMA1_REQ6_UART1_RECV
    #endif /* BSP_UART1_RX_USING_DMA */

    #if defined(BSP_UART1_TX_USING_DMA)
        #define UART1_TX_DMA_INSTANCE   DMA1_Channel1
        #define UART1_TX_DMA_IRQ        DMA1_IRQn
        #define UART1_TX_DMA_CHANNEL    1
        #define UART1_TX_DMA_REQUEST    DMA1_REQ5_UART1_SEND
    #endif /* BSP_UART1_TX_USING_DMA */

#endif /* BSP_USING_UART1 */

#if defined(BSP_USING_UART2)
    #define UART2_TX_PIN            "PA.2"
    #define UART2_RX_PIN            "PA.3"
    #define UART2_TX_ALTERNATE      GPIO_FUNCTION_1
    #define UART2_RX_ALTERNATE      GPIO_FUNCTION_1

    #if defined(BSP_UART2_RX_USING_DMA)
        #define UART2_RX_DMA_INSTANCE   DMA1_Channel0
        #define UART2_RX_DMA_IRQ        DMA1_IRQn
        #define UART2_RX_DMA_REQUEST    DMA1_REQ8_UART2_RECV
    #endif /* BSP_UART2_RX_USING_DMA */

    #if defined(BSP_UART2_TX_USING_DMA)
        #define UART2_TX_DMA_INSTANCE   DMA1_Channel1
        #define UART2_TX_DMA_IRQ        DMA1_IRQn
        #define UART2_TX_DMA_REQUEST    DMA1_REQ7_UART2_SEND
    #endif /* BSP_UART2_TX_USING_DMA */
#endif /* BSP_USING_UART2 */

#if defined(BSP_USING_UART3)
    #define UART3_TX_PIN            "PB.10"
    #define UART3_RX_PIN            "PB.11"
    #define UART3_TX_ALTERNATE      GPIO_FUNCTION_1
    #define UART3_RX_ALTERNATE      GPIO_FUNCTION_1

    #if defined(BSP_UART3_RX_USING_DMA)
        #define UART3_RX_DMA_INSTANCE   DMA1_Channel2
        #define UART3_RX_DMA_IRQ        DMA1_IRQn
        #define UART3_RX_DMA_REQUEST    DMA1_REQ29_UART3_RECV
    #endif /* BSP_UART3_RX_USING_DMA */

    #if defined(BSP_UART3_TX_USING_DMA)
        #define UART3_TX_DMA_INSTANCE   DMA1_Channel3
        #define UART3_TX_DMA_IRQ        DMA1_IRQn
        #define UART3_TX_DMA_REQUEST    DMA1_REQ28_UART3_SEND
    #endif /* BSP_UART3_TX_USING_DMA */
#endif /* BSP_USING_UART3 */

#if defined(BSP_USING_UART4)
    #define UART4_TX_PIN            "PC.10"
    #define UART4_RX_PIN            "PC.11"
    #define UART4_TX_ALTERNATE      GPIO_FUNCTION_4
    #define UART4_RX_ALTERNATE      GPIO_FUNCTION_4

    #if defined(BSP_UART4_RX_USING_DMA)
        #define UART4_RX_DMA_INSTANCE   DMA1_Channel4
        #define UART4_RX_DMA_IRQ        DMA1_IRQn
        #define UART4_RX_DMA_REQUEST    DMA1_REQ46_UART4_RECV
    #endif /* BSP_UART4_RX_USING_DMA */

    #if defined(BSP_UART4_TX_USING_DMA)
        #define UART4_TX_DMA_INSTANCE   DMA1_Channel5
        #define UART4_TX_DMA_IRQ        DMA1_IRQn
        #define UART4_TX_DMA_REQUEST    DMA1_REQ45_UART4_SEND
...
/*-------------------------- SPI CONFIG BEGIN --------------------------*/
    ...
    #define SPI1_CS_ALTERNATE       GPIO_FUNCTION_0

    #define SPI1_SCK_PORT           GPIOA
    #define SPI1_SCK_PIN            GPIO_PIN_5
    #define SPI1_SCK_ALTERNATE      GPIO_FUNCTION_0

    #define SPI1_MISO_PORT          GPIOA
    #define SPI1_MISO_PIN           GPIO_PIN_6
    #define SPI1_MISO_ALTERNATE     GPIO_FUNCTION_0

    #define SPI1_MOSI_PORT          GPIOA
    #define SPI1_MOSI_PIN           GPIO_PIN_7
    #define SPI1_MOSI_ALTERNATE     GPIO_FUNCTION_0

    #define SPI1_WP_PORT            GPIOA
    #define SPI1_WP_PIN             GPIO_PIN_7
    #define SPI1_WP_ALTERNATE       GPIO_FUNCTION_3

    #define SPI1_HOLD_PORT          GPIOA
    #define SPI1_HOLD_PIN           GPIO_PIN_6
    #define SPI1_HOLD_ALTERNATE     GPIO_FUNCTION_3
